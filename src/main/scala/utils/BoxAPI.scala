...
import utils.DatabaseAPI.{readApiKey, tableEndpointURI}
...
class BoxAPI(apiUrl: String, nodeUrl: String) {
  ...
  def convertJsonBoxToErgoBox(boxJson: BoxJson): InputBox = {
  ...
  def convertJsonBoxToErgoBox(boxJson: NodeBoxJson): InputBox = {
    val tokens = new java.util.ArrayList[Asset](boxJson.assets.length)
...
// mining address with plenty of utxos: mPdcmWTSJ6EJtnWk8LpK4ZXa7koomoiXgzZHGw8twRQ3U5W2npaixKAq6Fz5V5gfEhSXUBJ6YWMAu7pZ
